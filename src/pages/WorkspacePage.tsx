...
const EMPTY_DATA: ReportData = {
  patientInfo: {
    name: '', patientId: '', species: '', breed: '',
    gender: '', age: '', weight: '', surgeryDate: '', referralHospital: '',
  },
  chiefComplaint: '', bloodTests: '', vcmFindings: '', xrayFindings: '',
  ultrasoundFindings: '', ctFindings: '', surgicalProcedure: '', postopManagement: '',
  sections: [],
  images: [],
};
  ...
  const handleProcess = async () => {
    ...
    try {
      ...
      setReportData({
        ...EMPTY_DATA,
        ...parsed,
        patientInfo: { ...EMPTY_DATA.patientInfo, ...(parsed.patientInfo || {}) },
        images,
        sections: [],
      });
      setStep('edit');
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
        ...
        {step === 'upload' && (
          <div className="max-w-2xl mx-auto">
            <div className="mb-6">
              <h1 className="text-xl font-bold text-slate-800">진료 차트 업로드</h1>
              <p className="text-sm text-slate-500 mt-1">
                PDF 또는 DOCX 파일을 업로드하면 AI가 자동으로 보고서를 생성합니다.
              </p>
            </div>
            <UploadStep
              files={files}
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
            ...
            <div>
              <div className="mb-4 flex items-center justify-between">
                <div>
                  <h1 className="text-xl font-bold text-slate-800">내용 편집</h1>
                  <p className="text-sm text-slate-500 mt-0.5">AI가 추출한 내용을 확인하고 수정하세요.</p>
                </div>
                <button
            ...
            <div className="hidden xl:block">
              <div className="mb-4">
                <h2 className="text-xl font-bold text-slate-800">실시간 미리보기</h2>
                <p className="text-sm text-slate-500 mt-0.5">편집 내용이 실시간으로 반영됩니다.</p>
              </div>
        ...
        {step === 'preview' && (
          <div>
            <div className="mb-4 flex items-center justify-between">
              <div>
                <h1 className="text-xl font-bold text-slate-800">미리보기 · 출력</h1>
                <p className="text-sm text-slate-500 mt-0.5">인쇄하거나 이메일로 전송하세요.</p>
              </div>
              <button
